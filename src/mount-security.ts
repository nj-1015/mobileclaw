/**
 * Mount Security Module for MobileClaw
 *
 * Validates additional mounts against an allowlist stored OUTSIDE the project root.
 * This prevents container agents from modifying security configuration.
 *
 * Allowlist location: ~/.config/mobileclaw/mount-allowlist.json
 */
import fs from 'fs';
import os from 'os';
...
const logger = pino({
  level: process.env.MOBILECLAW_LOG_LEVEL || process.env.LOG_LEVEL || 'info',
